...
class PortfolioController extends Controller
{
    ...
    public function StorePortfolio(Request $request){
        ...
        $request->validate([
            ...
            'portfolio_name.required' => 'Название портфолио обязательно',
            'portfolio_title.required' => 'Заголовок портфолио обязателен',
        ]);
   ...
   public function UpdatePortfolio(Request $request){
        ...
        return redirect()->route('all.portfolio')->with($notification);
            ...
            $notification = array(
            'message' => 'Портфолио успешно обновлено без изображения',
            'alert-type' => 'success'
        );
