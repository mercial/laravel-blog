                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="p-3">
                                ...
                                Введите Вашь <strong>E-mail</strong> и инструкции будут отправлены!
                                ...
                                <div class="form-group pb-2 text-center row mt-3">
                                    <div class="col-12">
                                        <button class="btn btn-info w-100 waves-effect waves-light" type="submit">Сбросить пароль</button>
                                    </div>
                                </div>
                            </form>
                        </div>
