...
<div class="col-12">
    <div class="card">
        <div class="card-body">
            ...
            <h4 class="card-title">Редактор портфолио </h4>
            ...
            <div class="row mb-3">
                <label for="example-text-input" class="col-sm-2 col-form-label">Название портфолио</label>
                <div class="col-sm-10">
            ...
            <!-- end row -->
              ...
              <div class="row mb-3">
                <label for="example-text-input" class="col-sm-2 col-form-label">Заголовок портфолио </label>
                <div class="col-sm-10">
