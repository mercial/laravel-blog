        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="card-title">Слайдер на главной </h4>
                    ...
                    <!-- end row -->
                      ...
                      <div class="row mb-3">
                        <label for="example-text-input" class="col-sm-2 col-form-label">Короткое описание</label>
                        <div class="col-sm-10">
                    ...
                    <div class="row mb-3">
                        <label for="example-text-input" class="col-sm-2 col-form-label">Ссылка на видео</label>
                        <div class="col-sm-10">
               ...
               <input name="home_slide" class="form-control" type="file"  id="image">
                    ...
                    <!-- end row -->
        <input type="submit" class="btn btn-info waves-effect waves-light" value="Обновить слайдер">
                    </form>
