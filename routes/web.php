...
//Вывод на главную страницу админки сообщения, оставленные с формы на сайте
Route::get('/dashboard',function () {
    return view('admin.index');
})->middleware(['auth', 'verified'])->name('dashboard');
//, 'App\Http\Controllers\Home\ContactController@ContactMessage'
